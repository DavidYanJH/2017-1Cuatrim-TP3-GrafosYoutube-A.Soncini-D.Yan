...
def display_menu(grafo):
	...
	while (command != "exit"):
		...
		try:
			...
			print("Error. Comando Introducido Desconocido.")
			print("Mas informacion sobre los comandos disponibles acceda al manual con el comando '?'")
		print("\nA continuacion, introduzca un comando ('?' si desea acceder al manual con los comandos disponibles)")
		print("> ", end='')
		command = input()
